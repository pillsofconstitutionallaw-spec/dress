...
export const RETAILERS = [
  ...
  // Sportivi: per le scarpe da ginnastica e la parte athleisure del
  // guardaroba, dove i negozi di sopra non arrivano.
  { name: "Nike", fast: false, tier: "medio", search: (q) => `https://www.nike.com/it/w?q=${encodeURIComponent(q)}` },
  { name: "Puma", fast: false, tier: "accessibile", search: (q) => `https://eu.puma.com/it/it/search?q=${encodeURIComponent(q)}` },
  { name: "Asics", fast: false, tier: "medio", search: (q) => `https://www.asics.com/it/it-it/search/?q=${encodeURIComponent(q)}` },
  { name: "New Balance", fast: false, tier: "medio", search: (q) => `https://www.newbalance.it/search?q=${encodeURIComponent(q)}` },
  { name: "Lotto", fast: false, tier: "accessibile", search: (q) => `https://www.lottosport.com/search?q=${encodeURIComponent(q)}` },
];
