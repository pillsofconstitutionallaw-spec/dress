...
export const NOMI_COLORE = {
  ...
  "carta da zucchero": "#8AA5CE", skyblue: "#7EB2DD", darkblue: "#1E2E4F",
...
const SOLO_NEL_CAMPO = new Set(["shell", "silver", "rose", "stone"]);
...
function leggi(testo, nelCampo) {
  ...
  // Il nome per intero, prima di tutto: "blu notte" è in vocabolario.
  if (NOMI_COLORE[intero]) return NOMI_COLORE[intero];
  if (NOMI_COLORE[alMaschile(intero)]) return NOMI_COLORE[alMaschile(intero)];
