...
export const vendiSchema = {
  ...
  required: ["isGarment", "objectSeen", "title", "category", "description", "priceRange", "vintedTitle", "vintedDescription"],
};
...
Rispondi SOLO con JSON valido:
{"isGarment":true,"objectSeen":"...","title":"...","category":"...","description":"...","priceRange":"XX–YY €","vintedTitle":"...","vintedDescription":"..."}`;
}
