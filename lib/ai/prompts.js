...
// L'elenco da cui scegliere. Passarlo al modello serve a farlo restare
// dentro un vocabolario che l'app conosce, invece di inventarsi etichette
// diverse ogni volta e rendere impossibile cercare i capi.
const ELENCO_STILI = [
  "Minimal", "Classico", "Quiet luxury / Old money", "Casual", "Smart casual",
  "Business / Formale", "Streetwear", "Athleisure / Sportivo", "Bohémien",
  "Romantico", "Preppy", "Vintage / Retrò", "Grunge", "Rock / Edgy", "Y2K",
  "Cottagecore", "Gorpcore / Outdoor", "Dark academia", "Scandi",
  "Utilitario / Workwear", "Avant-garde", "Glam", "Normcore", "Coastal", "Artsy",
];
...
- Scegli SOLO da questo elenco: ${ELENCO_STILI.join(", ")}.
