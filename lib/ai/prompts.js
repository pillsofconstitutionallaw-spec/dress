...
export const abbinaSchema = {
  ...
  required: ["title", "category", "description", "matchTips"],
};
...
export const vendiSchema = {
  ...
  required: ["title", "category", "description", "priceRange", "vintedTitle", "vintedDescription"],
};
...
Osserva il capo nella foto e di' che cos'è e con cosa si mette.
...
{"title":"...","category":"...","description":"...","matchTips":["...","...","..."]}`;
}
...
Osserva il capo nella foto e scrivi l'ANNUNCIO, quello che si incolla su Vinted.
...
- vintedTitle: il titolo dell'inserzione, AL MASSIMO 100 caratteri — oltre, Vinted
  taglia. Scrivilo come lo scrivono i venditori bravi: tipo di capo, colore,
  materiale o taglio, e la taglia solo se si legge davvero. Niente maiuscole
...
Rispondi SOLO con JSON valido:
{"title":"...","category":"...","description":"...","priceRange":"XX–YY €","vintedTitle":"...","vintedDescription":"..."}`;
}
