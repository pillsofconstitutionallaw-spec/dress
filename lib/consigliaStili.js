...
export function consigliaStili(analisi, profile = {}, daiVestiti = null) {
  ...
  const sorgenti = [
    ...
    {
      chiave: "contrasto",
      lista: AFFINITA[contrasto >= 40 ? "contrastoAlto" : contrasto <= 22 ? "contrastoBasso" : "contrastoAlto"],
      motivo: PERCHE[contrasto >= 40 ? "contrastoAlto" : contrasto <= 22 ? "contrastoBasso" : "contrastoAlto"],
    },
