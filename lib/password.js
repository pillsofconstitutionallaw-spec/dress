...
export function controllaPassword(password = "") {
  ...
  // Le più usate al mondo: bloccarle vale più di dieci regole.
  const banali = ["password", "123456", "qwerty", "juventus", "napoli", "amoremio", "dressapp"];
  if (banali.some((b) => p.toLowerCase().includes(b))) {
