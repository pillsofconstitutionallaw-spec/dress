...
export function pertinenza(capo, genere) {
  ...
  // Chi non dice per chi è, fuori.
  //
  // Prima restavano, in fondo: buttarli sembrava caro, perché sono un capo
  // su tre. Ma "in fondo" vuol dire comunque dentro, e chi ha detto di
  // essere un uomo continuava a vedersi proporre pigiami e reggiseni — solo
  // più in basso. Non era la risposta a "sono un uomo": era un compromesso
  // fra la sua risposta e la nostra incertezza, e a pagarlo era lui.
  //
  // E i conti dicono che si può: a un uomo restano 20.946 capi invece di
  // 43.346, a una donna 33.395, e nessun negozio del catalogo sparisce.
  // Ventimila capi non sono pochi — sono più di quanti se ne guardino in
  // una vita.
  return null; // niente genere scritto, oppure quello opposto
}
